 ...
 */
class CRM_ExternalFile_Upgrader_Base {

  /**
   * @var CRM_ExternalFile_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_ExternalFile_Upgrader(
        'external-file',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_ExternalFile_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_ExternalFile_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
