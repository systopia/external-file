 ...
 * (GenCodeChecksum:f32c213e94de6013cf479932e19beb58)
 */
...
class CRM_ExternalFile_DAO_ExternalFile extends CRM_Core_DAO {
  ...
  /**
   * Unique identifier in combination with extension
   *
   * @var string
   *   (SQL type: varchar(255))
   *   Note that values will be retrieved from the database as a string.
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'identifier' => [
          ...
          'description' => E::ts('Unique identifier in combination with extension'),
          'required' => TRUE,
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'usage' => [
          ...
          'where' => 'civicrm_external_file.identifier',
          'table_name' => 'civicrm_external_file',
          'entity' => 'ExternalFile',
          'bao' => 'CRM_ExternalFile_DAO_ExternalFile',
          'localizable' => 0,
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      ...
      'UI_external_file_extension_identifier' => [
        'name' => 'UI_external_file_extension_identifier',
        'field' => [
          0 => 'extension',
          1 => 'identifier',
        ],
        'localizable' => FALSE,
        'unique' => TRUE,
        'sig' => 'civicrm_external_file::1::extension::identifier',
      ],
    ];
